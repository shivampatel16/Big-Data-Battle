 ...
 * File: OaklandCrimeStatsKML.java
 * Part Of: Project5 Part1 Task7
 *
 * This Java file defines a Hadoop Map Reduce program to run
 * through the input file and find the coordinates of the aggravated assault
 * crimes within 350 meters of 3803 Forbes Avenue in Oakland, which are later used
 * to build a KML file. The mapper finds the crimes that satisfy
 * the above condition and the reducer reduces the output from mapper to generate
 * the KML file.
 */

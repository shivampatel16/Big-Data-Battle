 ...
 * Part Of: Project5 Part1 Task1
 *
 * This Java file defines a Hadoop Map Reduce program to count the
 * frequency of each letter in the input file. The mapper tokenizes
 * the letters in the input file and the reducer reduces the tokens
 * to count the frequency of each letter in the input file.
 */

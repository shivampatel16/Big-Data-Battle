...
public class FindFact extends Configured implements Tool {
    ...
    public static class FindFactMap extends Mapper<LongWritable, Text, Text, NullWritable>
    {
    ...
    // and output key:value pair in Text and NullWritable
    public static class FindFactReducer extends Reducer<Text, NullWritable, Text, NullWritable>
    {
        /**
    ...
    public int run(String[] args) throws Exception  {
        ...
        job.setJarByClass(FindFact.class);

        // Set name of job
        job.setJobName("findfact");
        ...
        // Set mapper class
        job.setMapperClass(FindFactMap.class);

        // Set combiner class
        job.setCombinerClass(FindFactReducer.class);

        // Set reducer class
        job.setReducerClass(FindFactReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int result = ToolRunner.run(new FindFact(), args);
        System.exit(result);
    }
}

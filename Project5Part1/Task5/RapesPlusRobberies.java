 ...
 * File: RapesPlusRobberies.java
 * Part Of: Project5 Part1 Task5
 *
 * This Java file defines a Hadoop Map Reduce program to run
 * through the input file and find the count of crimes that
 * were classified as rapes and robberies in the input data. The mapper 
 * finds the crimes that were classified as rapes and robberies 
 * and the reducer reduces the output from mapper to find the count of 
